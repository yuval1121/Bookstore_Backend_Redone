...
<h4 align="center">A REST API simulating the server of a production ☕ shop web app built in Typescript, Fastify, Postgres, Github Actions , Node Tap and Prisma</a>.</h4>
